def inds(str): #tạo hàm in danh sách
#Thêm dấu cách vào sau dấu câu

#Xóa bỏ dấu cách trước dấu câu.

#Kết thúc câu không phải 1 trong 3 dấu ?.! thì thêm dấu . vào cuối.
    for i in range(-1, -len(str) - 1, -1):
        if i==-1:
            if (str[i]!='!'or str[i]!='.' or str[i]!='?'):
                str+='.'
#viết hoa chữ cái đầu câu và xóa bỏ dấu cách, tab dư
    word = str.title().split() #chuyển str về dạng split
